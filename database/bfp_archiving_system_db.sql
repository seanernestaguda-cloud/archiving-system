...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2025 at 10:52 PM
...
(1, 'admin123', 'admin', 'create', 1, NULL, '2025-12-11 05:45:07', 'Created report: Fire at Patadon West Farm');
...
INSERT INTO `fire_incident_reports` (`report_id`, `report_title`, `fire_location`, `street`, `purok`, `municipality`, `incident_date`, `establishment`, `victims`, `firefighters`, `property_damage`, `fire_types`, `uploader`, `department`, `caller_name`, `responding_team`, `arrival_time`, `fireout_time`, `alarm_status`, `occupancy_type`, `documentation_photos`, `narrative_report`, `progress_report`, `final_investigation_report`, `deleted`, `deleted_at`, `created_at`, `report_hash`) VALUES
(1, 'Fire at Patadon West Farm', 'Patadon West', 'Matalam Hardware', 'Purok 4', 'Matalam', '2025-12-11 05:44:00', 'Warehouse', '', '', '1,000,000', 'Wild Fires', 'admin123', 'Administrative', 'Carlos Dizon', 'Team A', '05:44', '05:44', '1st Alarm', 'Residential', '', '', '', '', 0, NULL, '2025-12-11 05:45:07', '7d26fe91131b5d3efcba085ea526ada99c31473ab6ef461f8c9461a23f57b4a4');
...
--
ALTER TABLE `barangays`
  MODIFY `barangay_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `fire_types`
  MODIFY `fire_types_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
