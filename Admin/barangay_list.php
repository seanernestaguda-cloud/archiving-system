                                    ...
                                    <td class="action-button-container">
                                        <form action="barangay_list.php" method="POST" style="display:flex;">
                                            <input type="hidden" name="barangay_id"
                                                value="<?php echo $barangay['barangay_id']; ?>">
                                            <button type="button"
                                                onclick="confirmDelete(<?php echo $barangay['barangay_id']; ?>)"
                                                class="delete-btn"><i class="fa-solid fa-trash"></i></button>
                                            <button type="button"
                                                onclick="openEditModal(<?php echo $barangay['barangay_id']; ?>, '<?php echo htmlspecialchars($barangay['barangay_name']); ?>')"
        ...
        <div id="addBarangayModal" class="report-details-modal">
            <div class="modal-content">
                ...
                <form id="addBarangayForm" method="POST" action="barangay_list.php">
                    ...
                    <input type="text" id="barangay_name" name="barangay_name" placeholder="Enter Barangay Name"
                        required>
