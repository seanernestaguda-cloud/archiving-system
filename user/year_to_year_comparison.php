...
$sql_years = "SELECT DISTINCT YEAR(incident_date) AS year FROM fire_incident_reports WHERE deleted_at IS NULL ORDER BY year DESC";
...
// Determine default years (latest two)
                    ...
                    <div class="date">
                        ...
                        <select name="year1" id="year1">
                            <?php foreach ($years as $y): ?>
                                <option value="<?php echo $y; ?>" <?php echo ($year1 == $y) ? 'selected' : ''; ?>>
                                    <?php echo $y; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
