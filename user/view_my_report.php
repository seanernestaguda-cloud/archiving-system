...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $can_edit) {
    ...
    if (isset($_POST['photos_to_delete']) && $_POST['photos_to_delete'] !== '') {
        ...
        foreach ($photos_to_delete as $photo_path) {
            ...
            $existing_photos = array_filter($existing_photos, function ($p) use ($photo_path) {
                return $p !== $photo_path;
            });
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $log_stmt->close();
            ...
            if ($report['uploader'] === $_SESSION['username']) {
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="form-header">
                    <div class="form-actions">
                        <form method="POST" action="generate_pdf.php?report_id=<?php echo $report_id; ?>">
                            <button type="submit" class="download-button"><i class="fa-solid fa-download"></i> Download
                                Report</button>
                        </form>
                    </div>
                ...
                <fieldset>
                    ...
                    <form method="POST" action="view_my_report.php?report_id=<?php echo $report_id; ?>"
                        ...
                        <div class="form-group-container">
                            ...
                            <div class="form-group" style="width: 45%; display: inline-block;">
                                ...
                                <input type="text" id="caller_name" name="caller_name"
                                    value="<?php echo htmlspecialchars($report['caller_name']); ?>" class="form-control"
                                    required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                            </div>

                            <div class="form-group" style="width: 45%; display: inline-block;">
                                <label for="responding_team">Responding Team</label>
                                <input type="text" id="responding_team" name="responding_team"
                                    value="<?php echo htmlspecialchars($report['responding_team']); ?>"
                                    class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                            </div>
                            <div class="form-group" style="width: 45%; display: inline-block;">
                                <label for="establishment">Establishment Name:</label>
                                <input type="text" id="establishment" name="establishment"
                                    value="<?php echo htmlspecialchars($report['establishment']); ?>"
                                    class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                            </div>
                            <br>
                            ...
                            <div class="form-group-container">
                                <div class="form-group" style="width: 45%; display: inline-block;">
                                    ...
                                    <input type="text" id="street" name="street"
                                        value="<?php echo htmlspecialchars($report['street'] ?? ''); ?>"
                                        class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                </div>
                                ...
                                <div class="form-group" style="width: 45%; display: inline-block;">
                                    ...
                                    <input type="text" id="purok" name="purok"
                                        value="<?php echo htmlspecialchars($report['purok'] ?? ''); ?>"
                                        class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                </div>
                                <div class="form-group" style="width: 45%; display: inline-block;">
                                    <label for="municipality">Municipality:</label>
                                    <input type="text" id="municipality" name="municipality"
                                        value="<?php echo htmlspecialchars($report['municipality'] ?? ''); ?>"
                                        class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                </div>
                                ...
                                <div class="form-group" style="width: 45%; display: inline-block;">
                                    ...
                                    <select id="fire_location" name="fire_location" class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($result_barangays)) { ?>
                                            <option value="<?php echo htmlspecialchars($row['barangay_name']); ?>" <?php echo ($report['fire_location'] === $row['barangay_name']) ? 'selected' : ''; ?>>
                            ...
                            <div class="form-group-container">
                                <div class="form-group" style="width: 30%; display: inline-block;">
                                    ...
                                    <input type="datetime-local" id="incident_date" name="incident_date"
                                        value="<?php echo htmlspecialchars($report['incident_date']); ?>"
                                        class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                </div>
                                <div class="form-group" style="width: 30%; display: inline-block;">
                                    <label for="arrival_time">Arrival Time:</label>
                                    <input type="time" id="arrival_time" name="arrival_time"
                                        value="<?php echo htmlspecialchars($report['arrival_time']); ?>"
                                        class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                </div>
                                <div class="form-group" style="width: 30%; display: inline-block;">
                                    <label for="fireout_time">Fireout Time:</label>
                                    <input type="time" id="fireout_time" name="fireout_time"
                                        value="<?php echo htmlspecialchars($report['fireout_time']); ?>"
                                        class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                </div>
                            </div>
                            <hr class="section-separator full-bleed">
                            ...
                            <div class="form-group" style="width: 45%; display: inline-block;">
                                ...
                                <input type="text" id="property_damage" name="property_damage"
                                    value="<?php echo htmlspecialchars($report['property_damage']); ?>"
                                    class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                            </div>
                        ...
                        <div class="form-group-container">
                            <div class="form-group" style="width: 45%; display: inline-block;">
                                ...
                                <select id="occupancy_type" name="occupancy_type" class="form-control" required <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                    ...
                                    <option value="Institutional" <?php echo ($report['occupancy_type'] === 'Institutional') ? 'selected' : ''; ?>>
                            ...
                            <div class="form-group" style="width: 45%; display: inline-block;">
                                ...
                                <select id="fire_types" name="fire_types" class="form-control" <?php echo !$can_edit ? 'disabled' : ''; ?>>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result_fire_types)) { ?>
                                        <option value="<?php echo htmlspecialchars($row['fire_types']); ?>" <?php echo ($report['fire_types'] === $row['fire_types']) ? 'selected' : ''; ?>>
                ...
                <fieldset>
                    ...
                    <div class="documents-section">
                        ...
                        <!-- Photo Gallery -->
                        <?php
                        $has_photos = !empty($report['documentation_photos']);
                        ?>
                        <section class="photo-gallery">
                            <h3>Photos of the Scene</h3>
                            <input type="hidden" id="existing_photos_input" name="existing_photos_input"
                                value="<?php echo htmlspecialchars($report['documentation_photos']); ?>">
                            ...
                            <?php if (!$has_photos) { ?>
                                <span class="empty-message"><i class="fa-regular fa-image" style="margin-right:8px;"></i>No
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="documentation_photos" name="documentation_photos[]"
                                class="form-control" multiple accept="image/*" onchange="previewImages(event)"
                                style="display:none;" <?php echo !$can_edit ? 'disabled' : ''; ?>>
                        </div>
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <div class="tab-container">
                            <button type="button" class="tab-btn" onclick="showTab('spot')">Spot Investigation
                                Report</button>
                            <button type="button" class="tab-btn" onclick="showTab('progress')">Progress Investigation
                                Report</button>
                        ...
                        <div class="form-group">
                            <?php if ($report['narrative_report']) { ?>
                                <div class="narrative-report">
                                    ...
                                    <a href="<?php echo $report['narrative_report']; ?>" target="_blank" class="btn-view"><i
                                            class="fa-solid fa-eye"></i></a>
                                    <a href="<?php echo $report['narrative_report']; ?>" download class="btn-download"><i
                                            class="fa-solid fa-download"></i></a>
                                    <button type="button" class="btn btn-delete"
                                        onclick="deleteReportFile('narrative_report', <?php echo $report_id; ?>)"><i
                                    ...
                                    <div id="narrative-preview" class="narrative-preview">
                                        ...
                                        if (strtolower($file_extension) === 'pdf') { ?>
                                            <iframe src="<?php echo $report['narrative_report']; ?>" width="220%"
                                                height="500px"></iframe>
                                        <?php } else { ?>
                                            <p>Preview not available for this file type. <a
                                                    href="<?php echo $report['narrative_report']; ?>" target="_blank">Download
                                                    to view the report.</a></p>
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php } else { ?>
                                <span class="empty-message"><i class="fa-regular fa-file-lines"
                                        style="margin-right:8px;"></i>No Spot Investigation Report uploaded.</span><br>
                            <?php } ?>
                            <div id="narrative-preview"></div><br>
                            <label for="narrative_report" id="narrative_report_label">
                                <?php echo empty($report['narrative_report']) ? 'Add New' : 'Change'; ?>
                            </label>
                        ...
                        <div class="form-group">
                            <?php if ($report['progress_report']) { ?>
                                <div class="narrative-report">
                                    ...
                                    <a href="<?php echo $report['progress_report']; ?>" target="_blank" class="btn-view"><i
                                            class="fa-solid fa-eye"></i></a>
                                    <a href="<?php echo $report['progress_report']; ?>" download class="btn-download"><i
                                            class="fa-solid fa-download"></i></a>
                                    <button type="button" class="btn btn-delete"
                                        onclick="deleteReportFile('progress_report', <?php echo $report_id; ?>)"><i
                                            class="fa-solid fa-trash"></i></button>
                                    <div id="progress-preview" class="narrative-preview">
                                        ...
                                        if (strtolower($file_extension) === 'pdf') { ?>
                                            <iframe src="<?php echo $report['progress_report']; ?>" width="220%"
                                                height="500px"></iframe>
                                        <?php } else { ?>
                                            <p>Preview not available for this file type. <a
                                                    href="<?php echo $report['progress_report']; ?>" target="_blank">Download to
                                                    view the report.</a></p>
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php } else { ?>
                                <span class="empty-message"><i class="fa-regular fa-file-lines"
                                        style="margin-right:8px;"></i>No Progress Report uploaded.</span><br>
                            <?php } ?>
                            <div id="progress-preview"></div><br>
                            <label for="progress_report" id="progress_report_label">
                                <?php echo empty($report['progress_report']) ? 'Add New' : 'Change'; ?>
                            </label>
                        ...
                        <div class="form-group">
                            <?php if ($report['final_investigation_report']) { ?>
                                <div class="narrative-report">
                                    ...
                                    <a href="<?php echo $report['final_investigation_report']; ?>" target="_blank"
                                        class="btn-view"><i class="fa-solid fa-eye"></i></a>
                                    <a href="<?php echo $report['final_investigation_report']; ?>" download
                                        class="btn-download"><i class="fa-solid fa-download"></i></a>
                                    <button type="button" class="btn btn-delete"
                                        onclick="deleteReportFile('final_investigation_report', <?php echo $report_id; ?>)"><i
                                            class="fa-solid fa-trash"></i></button>
                                    <div id="final-preview" class="narrative-preview">
                                        ...
                                        if (strtolower($file_extension) === 'pdf') { ?>
                                            <iframe src="<?php echo $report['final_investigation_report']; ?>" width="220%"
                                                height="500px"></iframe>
                                        <?php } else { ?>
                                            <p>Preview not available for this file type. <a
                                                    href="<?php echo $report['final_investigation_report']; ?>"
                                                    target="_blank">Download to view the report.</a></p>
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php } else { ?>
                                <span class="empty-message"><i class="fa-regular fa-file-lines"
                                        style="margin-right:8px;"></i>No Final Investigation Report uploaded.</span><br>
                            <?php } ?>
                            <div id="final-preview"></div><br>
                            <label for="final_investigation_report" id="final_investigation_report_label">
                                <?php echo empty($report['final_investigation_report']) ? 'Add New' : 'Change Final Investigation Report:'; ?>
                            </label>
                            <label for="final_investigation_report" class="file-icon-label"
                                id="final_investigation_report_icon">
                            ...
                            <input type="file" id="final_investigation_report" name="final_investigation_report"
                                ...
                                onchange="previewReport(event, 'final-preview')" <?php echo !$can_edit ? 'disabled' : ''; ?>>
                        </div>
                </fieldset>
...
<script>
    ...
    <?php if (isset($success_message)) { ?>
        showModal('<?php echo isset($redirect_target) ? $redirect_target : "my_fire_incident_reports.php"; ?>');
    <?php } ?>
