...
<div id="spot_report_section" class="report-section" style="display:none;">
    <div class="form-group">
        ...
        <?php if ($can_edit) { ?>
            ...
            <label for="narrative_report" style="font-weight: lighter;">
            ...
            <input type="file" id="narrative_report" name="narrative_report" class="form-control"
                accept=".pdf,.doc,.docx,.txt,.rtf" onchange="previewReport(event, 'narrative-preview')" style="display:none;" <?php echo !$can_edit ? 'disabled' : ''; ?>>
        <?php } ?>
    </div>
...
<div id="progress_report_section" class="report-section" style="display:none;">
    <div class="form-group">
        ...
        <?php if ($can_edit) { ?>
            ...
            <label for="progress_report" style="font-weight: lighter;">
            ...
            <input type="file" id="progress_report" name="progress_report" class="form-control"
                accept=".pdf,.doc,.docx,.txt,.rtf" onchange="previewReport(event, 'progress-preview')" style="display:none;" <?php echo !$can_edit ? 'disabled' : ''; ?>>
        <?php } ?>
    </div>
...
<div id="final_report_section" class="report-section" style="display:none;">
    <div class="form-group">
        ...
        <?php if ($can_edit) { ?>
            ...
            <label for="final_investigation_report" style="font-weight: lighter;">
                <?php echo empty($report['final_investigation_report']) ? 'Add New' : 'Change'; ?>
            </label>
            <input type="file" id="final_investigation_report" name="final_investigation_report" class="form-control"
                accept=".pdf,.doc,.docx,.txt,.rtf" onchange="previewReport(event, 'final-preview')" style="display:none;" <?php echo !$can_edit ? 'disabled' : ''; ?>>
        <?php } ?>
    </div>
        </div>
 </fieldset>
